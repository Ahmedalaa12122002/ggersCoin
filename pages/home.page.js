...
function renderHome() {
  ...
  content.innerHTML = `
    <style>
      ...
      .farm-plot.ready{
        background:
          radial-gradient(circle at top,#aed581,#689f38);
      }
      ...
      .plant.grow{
        animation:growAnim 1.6s ease-out;
      }

      .plant.idle{
        animation:plantIdle 2.8s ease-in-out infinite alternate;
      }

      .plant.harvest{
        animation:harvestAnim .6s ease forwards;
      }
